...
struct PlayerView: View {
    ...
    var body: some View {
            ...
            VStack(spacing: 32) {
                ...
                if let player = audioManager.player {
                    ...
                    HStack {
                        ...
                        PlaybackControl(systemName: "repeat", color: color) {
        ...
        .onAppear {
        //    AudioManager.shared.startPlayer(track: meditationVM.mediatation.track, isPreview: isPreview)
            audioManager.startPlayer(track: meditationVM.mediatation.track, isPreview: isPreview)
        }
